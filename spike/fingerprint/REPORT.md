...
## Headline
With signature gate: precision 0.69 at t=0.70 (recall 0.91, 116 labelled pairs)
Without signature gate: precision 0.69 at t=0.70 (recall 0.91, 116 labelled pairs)
...
(65 dup, 15 not), which caps the sweep from above. MIN_TOKENS stays at 40.
