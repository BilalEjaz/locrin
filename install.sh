...
#   ... | bash -s v0.6.1            pin a version (default: latest)
...
set -euo pipefail
# Everything runs inside main, called on the last line, so a download that is cut
# short mid-file cannot execute a prefix of the installer.
main() {
